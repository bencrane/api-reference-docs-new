...
**URL:** https://docs.emailbison.com/get-started/authentication

**API Keys:**
EmailBison uses Bearer tokens to authenticate requests. You can create tokens by visiting Settings -> Developer API -> New API Token. There are two types of tokens (keys) you can create:
...
**Authorization:**
All API requests should include your API key in an Authorization HTTP header as follows: `Authorization: Bearer YOUR_API_KEY`
