...
| `edges` | [`[LegalEntityAddressEdge]!`](/reference/graphql_api/objects/legal-entity-address-edge) | — | Contains the nodes in this connection. |
...
## Source
https://documentation.enigma.com/reference/graphql_api/objects/legal-entity-address-connection
