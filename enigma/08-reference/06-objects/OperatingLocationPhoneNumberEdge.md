...
## Overview
A Relay edge containing an `OperatingLocationPhoneNumber` and its cursor for pagination purposes.

## Fields

| Field Name | Type | Arguments | Description |
|---|---|---|---|
| node | [`PhoneNumber`](/reference/graphql_api/objects/phone-number) | — | The item at the end of the edge |
...
- **Member of Connection(s):** [`OperatingLocationPhoneNumberConnection`](/reference/graphql_api/objects/operating-location-phone-number-connection)
- **Member of Union(s):** None
- **Referenced by Input(s):** None
- **Referenced by Object(s):** None

## Source
https://documentation.enigma.com/reference/graphql_api/objects/operating-location-phone-number-edge
