...
| `edges` | [`[OperatingLocationNameEdge]!`](/reference/graphql_api/objects/operating-location-name-edge) | — | Contains the nodes in this connection. |
...
## Source
https://documentation.enigma.com/reference/graphql_api/objects/operating-location-name-connection
