...
Source: [https://modal.com/docs/examples/text_to_image](https://modal.com/docs/examples/text_to_image)
GitHub: [06_gpu_and_ml/stable_diffusion/text_to_image.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/stable_diffusion/text_to_image.py)
