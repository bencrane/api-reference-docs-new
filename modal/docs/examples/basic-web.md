...
Source: [https://modal.com/docs/examples/basic_web](https://modal.com/docs/examples/basic_web)
GitHub: [07_web_endpoints/basic_web.py](https://github.com/modal-labs/modal-examples/blob/main/07_web_endpoints/basic_web.py)
