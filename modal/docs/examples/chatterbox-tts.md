...
Source: [https://modal.com/docs/examples/chatterbox_tts](https://modal.com/docs/examples/chatterbox_tts)
GitHub: [06_gpu_and_ml/text-to-audio/chatterbox_tts.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/text-to-audio/chatterbox_tts.py)
