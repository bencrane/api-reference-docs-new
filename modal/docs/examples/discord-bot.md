...
Source: [https://modal.com/docs/examples/discord_bot](https://modal.com/docs/examples/discord_bot)
GitHub: [07_web_endpoints/discord_bot.py](https://github.com/modal-labs/modal-examples/blob/main/07_web_endpoints/discord_bot.py)
