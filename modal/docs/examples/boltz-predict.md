...
Source: [https://modal.com/docs/examples/boltz_predict](https://modal.com/docs/examples/boltz_predict)
GitHub: [06_gpu_and_ml/protein-folding/boltz_predict.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/protein-folding/boltz_predict.py)
