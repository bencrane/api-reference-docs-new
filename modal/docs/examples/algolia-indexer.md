...
Source: [https://modal.com/docs/examples/algolia_indexer](https://modal.com/docs/examples/algolia_indexer)
GitHub: [10_integrations/algolia_indexer.py](https://github.com/modal-labs/modal-examples/blob/main/10_integrations/algolia_indexer.py)
