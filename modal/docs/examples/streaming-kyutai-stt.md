...
Source: [https://modal.com/docs/examples/streaming_kyutai_stt](https://modal.com/docs/examples/streaming_kyutai_stt)
GitHub: [06_gpu_and_ml/speech-to-text/streaming_kyutai_stt.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/speech-to-text/streaming_kyutai_stt.py)
