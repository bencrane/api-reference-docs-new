...
Source: [https://modal.com/docs/examples/modal_tailscale](https://modal.com/docs/examples/modal_tailscale)
GitHub: [10_integrations/tailscale/modal_tailscale.py](https://github.com/modal-labs/modal-examples/blob/main/10_integrations/tailscale/modal_tailscale.py)
