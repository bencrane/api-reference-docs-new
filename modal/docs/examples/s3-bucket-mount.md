...
Source: [https://modal.com/docs/examples/s3_bucket_mount](https://modal.com/docs/examples/s3_bucket_mount)
GitHub: [10_integrations/s3_bucket_mount.py](https://github.com/modal-labs/modal-examples/blob/main/10_integrations/s3_bucket_mount.py)
