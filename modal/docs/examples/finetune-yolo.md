...
Source: [https://modal.com/docs/examples/finetune_yolo](https://modal.com/docs/examples/finetune_yolo)
GitHub: [06_gpu_and_ml/yolo/finetune_yolo.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/yolo/finetune_yolo.py)
