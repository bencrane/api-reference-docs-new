...
Source: [https://modal.com/docs/examples/blender_video](https://modal.com/docs/examples/blender_video)
GitHub: [06_gpu_and_ml/blender/blender_video.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/blender/blender_video.py)
