...
Source: [https://modal.com/docs/examples/safe_code_execution](https://modal.com/docs/examples/safe_code_execution)
GitHub: [13_sandboxes/safe_code_execution.py](https://github.com/modal-labs/modal-examples/blob/main/13_sandboxes/safe_code_execution.py)
