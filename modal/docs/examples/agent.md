...
Source: [https://modal.com/docs/examples/agent](https://modal.com/docs/examples/agent)
GitHub: [13_sandboxes/codelangchain/agent.py](https://github.com/modal-labs/modal-examples/blob/main/13_sandboxes/codelangchain/agent.py)
