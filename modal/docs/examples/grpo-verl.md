...
Source: [https://modal.com/docs/examples/grpo_verl](https://modal.com/docs/examples/grpo_verl)
GitHub: [06_gpu_and_ml/reinforcement-learning/grpo_verl.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/reinforcement-learning/grpo_verl.py)
