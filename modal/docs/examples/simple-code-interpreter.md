...
Source: [https://modal.com/docs/examples/simple_code_interpreter](https://modal.com/docs/examples/simple_code_interpreter)
GitHub: [13_sandboxes/simple_code_interpreter.py](https://github.com/modal-labs/modal-examples/blob/main/13_sandboxes/simple_code_interpreter.py)
