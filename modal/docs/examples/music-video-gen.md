...
> Generate personalized music videos with AI on Modal. Deploy your own music video generator using serverless GPU infrastructure.

Source: [https://modal.com/docs/examples/music-video-gen](https://modal.com/docs/examples/music-video-gen)
