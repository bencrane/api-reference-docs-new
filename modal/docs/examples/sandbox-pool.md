...
Source: [https://modal.com/docs/examples/sandbox_pool](https://modal.com/docs/examples/sandbox_pool)
GitHub: [13_sandboxes/sandbox_pool.py](https://github.com/modal-labs/modal-examples/blob/main/13_sandboxes/sandbox_pool.py)
