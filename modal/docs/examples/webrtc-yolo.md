...
Source: [https://modal.com/docs/examples/webrtc_yolo](https://modal.com/docs/examples/webrtc_yolo)
GitHub: [07_web_endpoints/webrtc/webrtc_yolo.py](https://github.com/modal-labs/modal-examples/blob/main/07_web_endpoints/webrtc/webrtc_yolo.py)
