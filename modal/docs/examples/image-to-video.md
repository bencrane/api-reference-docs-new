...
Source: [https://modal.com/docs/examples/image_to_video](https://modal.com/docs/examples/image_to_video)
GitHub: [06_gpu_and_ml/image-to-video/image_to_video.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/image-to-video/image_to_video.py)
