...
> This tutorial shows you how to use Modal to deploy a fully serverless React + FastAPI application.

Source: [https://modal.com/docs/examples/doc_ocr_webapp](https://modal.com/docs/examples/doc_ocr_webapp)
GitHub: [09_job_queues/doc_ocr_webapp.py](https://github.com/modal-labs/modal-examples/blob/main/09_job_queues/doc_ocr_webapp.py)
