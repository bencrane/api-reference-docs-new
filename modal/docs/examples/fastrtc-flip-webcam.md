...
Source: [https://modal.com/docs/examples/fastrtc_flip_webcam](https://modal.com/docs/examples/fastrtc_flip_webcam)
GitHub: [07_web_endpoints/fastrtc_flip_webcam.py](https://github.com/modal-labs/modal-examples/blob/main/07_web_endpoints/fastrtc_flip_webcam.py)
