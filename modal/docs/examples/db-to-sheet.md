...
Source: [https://modal.com/docs/examples/db_to_sheet](https://modal.com/docs/examples/db_to_sheet)
GitHub: [04_secrets/db_to_sheet.py](https://github.com/modal-labs/modal-examples/blob/main/04_secrets/db_to_sheet.py)
