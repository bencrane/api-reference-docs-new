...
Source: [https://modal.com/docs/examples/doc_ocr_jobs](https://modal.com/docs/examples/doc_ocr_jobs)
GitHub: [09_job_queues/doc_ocr_jobs.py](https://github.com/modal-labs/modal-examples/blob/main/09_job_queues/doc_ocr_jobs.py)
