...
Source: [https://modal.com/docs/examples/vllm_throughput](https://modal.com/docs/examples/vllm_throughput)
GitHub: [06_gpu_and_ml/llm-serving/vllm_throughput.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/llm-serving/vllm_throughput.py)
