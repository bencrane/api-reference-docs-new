...
Source: [https://modal.com/docs/examples/dbt_duckdb](https://modal.com/docs/examples/dbt_duckdb)
GitHub: [10_integrations/dbt/dbt_duckdb.py](https://github.com/modal-labs/modal-examples/blob/main/10_integrations/dbt/dbt_duckdb.py)
