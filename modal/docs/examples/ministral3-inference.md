...
Source: [https://modal.com/docs/examples/ministral3_inference](https://modal.com/docs/examples/ministral3_inference)
GitHub: [06_gpu_and_ml/llm-serving/ministral3_inference.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/llm-serving/ministral3_inference.py)
