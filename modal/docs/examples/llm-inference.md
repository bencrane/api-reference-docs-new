...
Source: [https://modal.com/docs/examples/llm_inference](https://modal.com/docs/examples/llm_inference)
GitHub: [06_gpu_and_ml/llm-serving/vllm_inference.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/llm-serving/vllm_inference.py)
