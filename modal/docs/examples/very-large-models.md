...
Source: [https://modal.com/docs/examples/very_large_models](https://modal.com/docs/examples/very_large_models)
GitHub: [06_gpu_and_ml/llm-serving/very_large_models.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/llm-serving/very_large_models.py)
