...
Source: [https://modal.com/docs/examples/unsloth_finetune](https://modal.com/docs/examples/unsloth_finetune)
GitHub: [06_gpu_and_ml/unsloth_finetune.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/unsloth_finetune.py)
