...
Source: [https://modal.com/docs/examples/batched_whisper](https://modal.com/docs/examples/batched_whisper)
GitHub: [06_gpu_and_ml/speech-to-text/batched_whisper.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/speech-to-text/batched_whisper.py)
