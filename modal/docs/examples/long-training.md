...
> Individual Modal Function calls have a maximum timeout of 24 hours. You can still run long training jobs on Modal by making them interruptible and resumable (aka reentrant).

Source: [https://modal.com/docs/examples/long-training](https://modal.com/docs/examples/long-training)
GitHub: [06_gpu_and_ml/long-training.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/long-training.py)
