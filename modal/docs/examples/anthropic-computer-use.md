...
Source: [https://modal.com/docs/examples/anthropic_computer_use](https://modal.com/docs/examples/anthropic_computer_use)
GitHub: [13_sandboxes/anthropic_computer_use.py](https://github.com/modal-labs/modal-examples/blob/main/13_sandboxes/anthropic_computer_use.py)
