...
Source: [https://modal.com/docs/examples/grpo_trl](https://modal.com/docs/examples/grpo_trl)
GitHub: [06_gpu_and_ml/reinforcement-learning/grpo_trl.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/reinforcement-learning/grpo_trl.py)
