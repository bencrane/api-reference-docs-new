...
Source: [https://modal.com/docs/examples/mcp_server_stateless](https://modal.com/docs/examples/mcp_server_stateless)
GitHub: [10_integrations/mcp_server_stateless.py](https://github.com/modal-labs/modal-examples/blob/main/10_integrations/mcp_server_stateless.py)
