...
Source: [https://modal.com/docs/examples/opencode_server](https://modal.com/docs/examples/opencode_server)
GitHub: [13_sandboxes/opencode_server.py](https://github.com/modal-labs/modal-examples/blob/main/13_sandboxes/opencode_server.py)
