...
Source: [https://modal.com/docs/examples/flux](https://modal.com/docs/examples/flux)
GitHub: [06_gpu_and_ml/stable_diffusion/flux.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/stable_diffusion/flux.py)
