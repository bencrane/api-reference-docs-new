...
Source: [https://modal.com/docs/examples/serve_streamlit](https://modal.com/docs/examples/serve_streamlit)
GitHub: [10_integrations/streamlit/serve_streamlit.py](https://github.com/modal-labs/modal-examples/blob/main/10_integrations/streamlit/serve_streamlit.py)
