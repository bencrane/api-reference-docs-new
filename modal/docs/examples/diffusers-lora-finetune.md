...
Source: [https://modal.com/docs/examples/diffusers_lora_finetune](https://modal.com/docs/examples/diffusers_lora_finetune)
GitHub: [06_gpu_and_ml/dreambooth/diffusers_lora_finetune.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/dreambooth/diffusers_lora_finetune.py)
