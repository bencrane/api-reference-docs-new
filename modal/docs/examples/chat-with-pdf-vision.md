...
Source: [https://modal.com/docs/examples/chat_with_pdf_vision](https://modal.com/docs/examples/chat_with_pdf_vision)
GitHub: [06_gpu_and_ml/llm-serving/chat_with_pdf_vision.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/llm-serving/chat_with_pdf_vision.py)
