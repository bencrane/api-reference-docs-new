...
Source: [https://modal.com/docs/examples/amazon_embeddings](https://modal.com/docs/examples/amazon_embeddings)
GitHub: [06_gpu_and_ml/embeddings/amazon_embeddings.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/embeddings/amazon_embeddings.py)
