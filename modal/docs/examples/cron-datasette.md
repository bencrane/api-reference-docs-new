...
Source: [https://modal.com/docs/examples/cron_datasette](https://modal.com/docs/examples/cron_datasette)
GitHub: [10_integrations/cron_datasette.py](https://github.com/modal-labs/modal-examples/blob/main/10_integrations/cron_datasette.py)
