...
Source: [https://modal.com/docs/examples/generate_music](https://modal.com/docs/examples/generate_music)
GitHub: [06_gpu_and_ml/text-to-audio/generate_music.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/text-to-audio/generate_music.py)
