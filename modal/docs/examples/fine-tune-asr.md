...
Source: [https://modal.com/docs/examples/fine_tune_asr](https://modal.com/docs/examples/fine_tune_asr)
GitHub: [06_gpu_and_ml/openai_whisper/fine_tune_asr.py](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/openai_whisper/fine_tune_asr.py)
