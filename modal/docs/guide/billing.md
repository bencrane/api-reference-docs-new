...
Modal is serverless, which means you only pay for the compute you use or request. Reservations are not required, and there are no minimum usage-time increments. Up-to-date unit pricing for all of our products is available on our Pricing page.
...
We also offer programmatic APIs for exporting billing reports to workspaces at the Team and Enterprise plan levels. Use the APIs in modal.billing or the modal billing CLI to generate tabular reports of spend over time broken down across specific Modal Apps or other resources.
...
Invoiced billing, international bank transfer payment methods, splitting invoices, and other custom requirements are available to customers on an Enterprise plan who have a usage commitment with us. Please contact sales@modal.com.
