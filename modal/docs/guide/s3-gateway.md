...
When running workloads in AWS, our system automatically uses a corresponding S3 Gateway endpoint to ensure low costs, optimal performance, and network reliability between Modal and S3.
...
You can prevent this by scheduling your Modal App in the same region of your S3 bucket with Region selection.
