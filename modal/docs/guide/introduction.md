...
You get full serverless execution and pricing because we host everything and charge per second of usage. Notably, there's zero configuration in Modal - everything, including container environments and GPU specification, is code. Take a breath of fresh air and feel how good it tastes with no YAML in it.
...
Check out some of our simple getting started examples:

- [Hello, world!](https://modal.com/docs/examples/hello_world)
- [A simple web scraper](https://modal.com/docs/examples/web_scraper)

And when you're ready for something fancier, explore our full library of [examples](https://modal.com/docs/examples), like:

- [Running your own LLM inference](https://modal.com/docs/examples/vllm_inference)
- [Transcribing speech in real time with Kyutai STT](https://modal.com/docs/examples/speech_to_text)
- [Fine-tuning Flux](https://modal.com/docs/examples/flux_finetune)
- [Building a coding agent with Modal Sandboxes and LangGraph](https://modal.com/docs/examples/agent)
- [Training a small language model from scratch](https://modal.com/docs/examples/llm_training)
- [Parallel processing of Parquet files on S3](https://modal.com/docs/examples/parallel_processing)
- [Parsing documents with dots.ocr in a Modal Notebook](https://modal.com/docs/examples/dots_ocr)
