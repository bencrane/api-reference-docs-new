...
This feature is in beta. We’d love to hear your feedback — please reach out via Slack or email us at support@modal.com.
...
Modal supports Role-Based Access Control (RBAC) to restrict access at both the Workspace and Environment level. Use RBAC to ensure your service users can only deploy to the Environments they’re authorized for.
