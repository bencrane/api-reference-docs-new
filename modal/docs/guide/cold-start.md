...
Modal’s custom container stack has been heavily optimized to reduce this time. You can read about some of our optimizations here. Containers boot in about one second.
...
Modal currently exposes three parameters that control how many containers will be warm: scaledown_window, min_containers, and buffer_containers.
...
Cold starts can also be made faster by using Modal Memory Snapshots.
...
Refer to the Memory Snapshots guide for details.
