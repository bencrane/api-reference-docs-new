...
You can also create tunnels on a Sandbox to directly expose the container’s ports.
...
All Modal features are supported. If you need GPUs, pass gpu= to the @app.function() decorator. If you need more CPUs, RAM, or to attach volumes, those also just work.
