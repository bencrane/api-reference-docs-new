# Custom SAML SSO
Custom SAML SSO is available on the Enterprise plan. Contact sales@modal.com for more information.
...
Set the Entity ID to https://www.modal.com
Set the ACS URL to https://modal.com/api/okta/saml/sso/<workspace> (replace <workspace> with your Workspace name)
...
Make sure the SAML attributes are mapped correctly. For example, email should be lowercase and the SAML attribute should not have a namespace. Read more about Microsoft Entra SAML attributes here.
